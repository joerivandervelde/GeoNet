...
class GAT(nn.Module):
    def __init__(self, x_ind, x_hs, u_ind, edge_ind, hidden, heads=1, nlayers=4, concat=False,
        ...
        self.clf = nn.Sequential(
            ...
            nn.Linear((x_hs * nlayers) * 2, hidden),
...
class GeoNet(torch.nn.Module):
    def __init__(self, nlayers, heads, x_ind, edge_ind, x_hs, e_hs, u_hs, hidden, dropratio, bias, edge_method,
        ...
        self.gat = GAT(x_ind=x_ind, x_hs=x_hs, u_ind=self.u_ind, edge_ind=edge_ind, hidden=hidden, nlayers=nlayers,
