...
from ModelCode.GN_model_gat_hidden import GeoNet
...
def parse_args():
    ...
    parser.add_argument("--hidden_clf", dest='hidden_clf', type=int, default=128,
                        help='The dimension of hidden size in classification.')
...
def checkargs(args):
    ...
    if args.ligand not in ['DNA', 'RNA', 'CA', 'MN', 'MG', 'ATP', 'HEME', 'P']:
...
class Config():
    def __init__(self, args):
        ...
        self.hidden_clf = args.hidden_clf
        ...
        os.system(f'cp training_gat_hidden.py {self.model_path}')
        os.system(f'cp ../ModelCode/GN_model_gat_hidden.py {self.model_path}')
